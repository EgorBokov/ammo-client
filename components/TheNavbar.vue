  ...
  <div class="bg-[#fff] h-[80px] px-[20px] py-[1rem] flex items-center justify-between shadow-[]">
    ...
    <nav class="flex items-center gap-[10px]">
      <NuxtLink
          ...
          :key="item.id"
          :to="item.href"
          class="block p-[15px] text-black rounded-[100px] decoration-0 duration-300 hover:tracking-[0.4px] hover:bg-[rgba(255,215,44,1)]"
    ...
    <div
        ...
        class="rounded-[100px] flex w-[40px] h-[40px] cursor-pointer justify-center items-center relative duration-300 hover:bg-[rgba(0,0,0,0.1)]"
    >
      <div
          v-if="cartAmount"
