...
const popularPositions: Array<IPopularPosition> = [
    { id: 1, name: "Разгрузочный жилет", price: '2480', link: '/catalog/armors/8', image: 'uploadguard.png', productId: 8, route: 'armors'},
    { id: 2, name: "Подсумок под аптечки", price: '480', link: '/catalog/medical-kits/2', image: 'medical-subkit.png', productId: 2, route: 'medical-kits'},
    { id: 3, name: "Пуленепробиваемый шлем", price: '13000', link: '/catalog/armors/2', image: 'helmet2.png', productId: 2, route: 'armors'},
    { id: 4, name: "Тактические перчатки", price: '600', link: '/catalog/clothes/17', image: 'gloves.png', productId: 17, route: 'clothes'},
